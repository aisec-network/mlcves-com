...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Every CVE that touches ML frameworks. Tracked." },
...
export const siteConfig: SiteConfig = {
  domain: "mlcves.com",
  url: "https://mlcves.com",
  title: "ML CVEs",
  tagline: "CVEs in ML libraries, frameworks, and the AI/ML supply chain.",
  description:
  ...
  byline: "ML CVEs Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 220, cluster: "offensive" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@mlcves.com",
    abuse: "abuse@mlcves.com",
    editor: "editor@mlcves.com",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "mlcves.com"),
  analytics: {},
};
